        ...
        <div className='font-Inter font-[400] text-[20px] leading-[30px]'>
            <div className='mx-[230px] w-[980px] h-[626px] border-[3px] rounded-[35px]'>
                ...
                <div className='mt-[15px] ml-[31px] w-[919px] h-[216px]'>
                    ...
                    {meaning[0]?.meanings ? (
                        turn === "noun" ? (
                            meaning[0].meanings[0]?.definitions.slice(0, 3).map((item: { definition: string }, index: number) => (
                            ...
                            meaning[0]?.meanings[1]?.definitions.slice(0, 3).map((item: { definition: string }, index: number) => (
                                <div className="flex gap-2" key={index}>
                                    <p>{index + 1}.</p>
                                    <p>{item.definition}</p>
                                </div>
